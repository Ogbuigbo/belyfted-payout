...
function WhyChooseSection() {
  return (
    <div className="mt-[70px] flex flex-col justify-center items-center px-6">
      <h1 className="text-3xl font-extrabold text-[#303032] text-center">
        Why Choose YodePay Checkout?
      </h1>

      {/* Features Grid */}
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-[1200px] mx-auto">
        {/* Instant Settlements */}
        <div className="px-[19px] py-[21px] hover:shadow-md  border border-gray-200 rounded-3xl bg-white">
          ...
          <p className="text-sm text-[#474649] font-medium leading-relaxed">
            Receive funds directly to your wallet or bank account without
            delays.
          </p>
        </div>
        ...
        <div className="px-[19px] py-[21px]  border border-gray-200 rounded-3xl bg-white hover:shadow-md transition-shadow">
          ...
          <p className="text-sm text-[#474649] font-medium leading-relaxed">
            Offer your customers various payment methods including cards, bank
        ...
        <div className="px-[19px] py-[21px]  border border-gray-200 rounded-3xl bg-white hover:shadow-md transition-shadow">
          ...
          <p className="text-sm text-[#474649] font-medium leading-relaxed">
            Seamlessly integrate with your platform using our simple API or
            no-code solutions.
          </p>
        </div>
        ...
        <div className="px-[19px] py-[21px]  border border-gray-200 rounded-3xl bg-white hover:shadow-md transition-shadow">
          ...
          <p className="text-sm text-[#474649] font-medium leading-relaxed">
            Provide a checkout experience that adapts to your customer's
